...
Mdir = '/Users/nico/Desktop/simulation_outputs/percolation/Ata_structures/tempdot5/MOs_ARPACK/virtual/'
...
gamL = np.load(f'/Users/nico/Desktop/simulation_outputs/percolation/Ata_structures/tempdot5/MO_gammas/gamL_40x40-{nsample}_virtual.npy')
gamR = np.load(f'/Users/nico/Desktop/simulation_outputs/percolation/Ata_structures/tempdot5/MO_gammas/gamR_40x40-{nsample}_virtual.npy')
...
# psi = M[:,nn]
# clust_cc, ll, flagged_ll = assign_AOs(pos, cc, psi, psi_pow=6, flag_empty_clusters=True)
