...
from MOs2sites import generate_sites_radii_list, LR_MOs, sites_mass, assign_AOs, get_MO_loc_centers_opt, site_radii
...
for n in range(M.shape[1]):
    ...
    # cc_hl = centers_hl[jj,:]
    # rr = radii_hl[jj]
    # r_sorted_hl[l:l+nsites] = rr
    # masses_hl[l:l+nsites] = sites_mass(psi,tree,cc_hl,rr)
    # l += nsites
...
fig, ax = plt.subplots()
ax.scatter(r_sorted,masses,c='r',s=5.0,label='$|\psi_n|^2$',alpha=0.5)
# ax.scatter(r_sorted_hl,masses_hl,c='b',s=5.0,label='$|\psi_n|^4$',alpha=0.5)
