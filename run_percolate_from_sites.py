...
from var_a_percolate_mac.deploy_percolate import run_percolate_from_sites
...
run_percolate_from_sites(pos,M,S,temps, dV, eF=efermi,hyperlocal=False,npydir=npydir,run_name=run_name,rmax=rmax,dE_max=e_thermal,rotate=False,pkl_dir=pkl_dir)
