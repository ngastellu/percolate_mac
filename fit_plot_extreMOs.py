...
from utils_analperc import get_dcrits, saddle_pt_sigma, arrhenius_fit, mott_fit


datadir = '/Users/nico/Desktop/simulation_outputs/percolation/40x40/percolate_output/extremal_MOs/lo50/'
...
slope, intercept, x, y = mott_fit(temps,sigmas,return_for_plotting=True)
T0 = slope**3
