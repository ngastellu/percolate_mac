...
# datadir = '/Users/nico/Desktop/simulation_outputs/percolation/Ata_structures/tdot25/percolate_output/zero_field/extremal_MOs/lo50'
datadir = '/Users/nico/Desktop/simulation_outputs/percolation/40x40/percolate_output/extremal_MOs/a0_3/lo50/eF_min_ei/'
...
slope, intercept, x, y = arrhenius_fit(temps,sigmas,inv_T_scale=1000.0,return_for_plotting=True, x_start=istart)
Ea = -slope*kB*1e6
...
ax.plot(x[istart:],slope*x[istart:]+intercept,'r-',lw=0.8)
ax.plot(x[istart-5:istart+1],slope*x[istart-5:istart+1]+intercept,'r--',lw=0.8)
...
slope, intercept, x, y = mott_fit(temps,sigmas, return_for_plotting=True, x_start=istart)
T0 = -slope**3
...
slope, intercept, x, y = mott_fit(temps,sigmas,d=1,return_for_plotting=True, x_start=istart)
T0 = -slope**2
