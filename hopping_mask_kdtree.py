...
radii = np.load(f'sample-{nn}/sites_data_{eps_rho}_psi_pow{psi_pow}/radii.npy')
centres = np.load(f'sample-{nn}/sites_data_{eps_rho}_psi_pow{psi_pow}/centers.npy')
...
np.save(f'strict_hopping_masks_psipow{psi_pow}/strict_hopping_mask-{nn}.npy', mask)
