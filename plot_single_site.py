...
sitesdir = os.path.join(simdir, f'percolation/{structype}/var_radii_data/to_local_sites_data_0.00105_psi_pow1/sample-{istruc}')
...
plot_MO(pos, S, istate, dotsize=0.5,loc_centers=np.array([centers[istate]]), loc_radii=[radii[istate]])